...
import { Calculator, Sparkles, Construction, ArrowLeft } from 'lucide-react';
        ...
        <div className="h-[80vh] flex flex-col items-center justify-center text-center space-y-8 animate-in fade-in zoom-in duration-700">
            ...
            <div className="space-y-4 max-w-lg">
                <h1 className="text-5xl font-black text-primary italic leading-tight">
                    Simulador <span className="text-accent underline decoration-accent/10">Tributário</span>
                </h1>
                ...
                <p className="text-primary/60 font-medium leading-relaxed">
                    Estamos calibrando os algoritmos de cálculo para Lucro Real e Presumido.
                    Este módulo estará disponível na próxima atualização do sistema.
                </p>
            </div>
