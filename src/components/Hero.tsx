    ...
    return (
        <section className="relative pt-32 pb-20 overflow-hidden">
            ...
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full -z-10 opacity-30 pointer-events-none">
                ...
                <div className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-neon/10 rounded-full blur-[120px]" />
            </div>
            ...
            <div className="container mx-auto px-6">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <p className="text-lg md:text-xl text-primary/60 mb-12 max-w-2xl mx-auto">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-20">
                        ...
                        <Link
                            href="/auth/login"
                            className="w-full sm:w-auto px-8 py-4 bg-white border-2 border-primary/10 hover:border-primary text-primary font-bold rounded-xl transition-all hover:translate-y-[-2px] shadow-lg flex items-center justify-center gap-2"
                        >
                            Acessar Plataforma
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="glass p-6 rounded-2xl flex flex-col items-center gap-4 hover:border-accent/40 transition-colors">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-primary/40">Recuperados em Créditos</p>
                            </div>
                        </div>
                        <div className="glass p-6 rounded-2xl flex flex-col items-center gap-4 hover:border-accent/40 transition-colors">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-primary/40">Conformidade Legal</p>
                            </div>
                        </div>
                        <div className="glass p-6 rounded-2xl flex flex-col items-center gap-4 hover:border-accent/40 transition-colors">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-primary/40">Empresas Atendidas</p>
                            </div>
                        </div>
                    </div>
                </div>
